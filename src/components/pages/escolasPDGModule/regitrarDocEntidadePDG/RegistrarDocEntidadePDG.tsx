...
export default function RegistrarDocEntidadePDG(): JSX.Element {
  ...
  const { idEntidadeEscolar, setPageEscolasPDG } = useGlobalContext();
  const addInput = () => {
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <PageContentContainer>
        <NavigationButtons setPageEscolasPDG={setPageEscolasPDG} />
        <FormComponent
...
const NavigationButtons: React.FC<{
  setPageEscolasPDG: React.Dispatch<React.SetStateAction<PageEnumEscolasPDG>>;
}> = ({ setPageEscolasPDG }) => (
  <div className={styles.boxBtns}>
    <BackButton
      ...
      text="Voltar"
      size="8rem"
      onClick={() => setPageEscolasPDG(PageEnumEscolasPDG.docsEscola)}
    />
  </div>
);
