        ...
        <div className={boxRanges}>
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              value={Number(formDataCriteriaToSubmit.e1) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.e2) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.e3) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.e4) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.e5) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.e6) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.m1) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.m2) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.m3) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              trackClassName={styles.track}
              min={-1}
              value={Number(formDataCriteriaToSubmit.m4) || null}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.m5) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.m6) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.l1) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.l2) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.l3) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.l4) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.l5) || null}
              min={-1}
              max={1}
              step={0.02}
          ...
          <label className={inputRangeClass}>
            ...
            <ReactSlider
              ...
              thumbClassName={styles.thumb}
              trackClassName={styles.track}
              value={Number(formDataCriteriaToSubmit.l6) || null}
              min={-1}
              max={1}
              step={0.02}
